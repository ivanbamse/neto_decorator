from decor import logger_by_filename
from typing import List, Union, NoReturn, AnyStr
import re, csv

def loggind_phonebook():
    ...
    @logger_by_filename('_get_row_contacts.log')
    ...
    @logger_by_filename('_compare_data.log')
    ...
    @logger_by_filename('_same_person.log')
    ...
    @logger_by_filename('_filling_up_data.log')
    ...
    @logger_by_filename('_ordering_data.log')
    ...
    @logger_by_filename('_saving_data.log')
